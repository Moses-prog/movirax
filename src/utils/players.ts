...
export const getTvShowPlayers = (
  ...
  return [
    ...
    {
      title: "Movirax Server 10",
      source: `https://vidsrc.sh/embed/tv/${id}/${season}/${episode}?autonext=1`,
      ads: true,
    },
    {
      title: "Movirax Server 11",
      source: `https://vidsrc.me/embed/tv/${id}/${season}/${episode}?autonext=1`,
      ads: true,
    },
    {
      title: "Movirax Server 12",
      source: `https://vidsrc.in/embed/tv/${id}/${season}/${episode}?autonext=1`,
      ads: true,
    },
    {
      title: "Movirax Server 13",
      source: `https://vidsrc.pm/embed/tv/${id}/${season}/${episode}?autonext=1`,
      ads: true,
    },
    {
