...
export const siteConfig: SiteConfigType = {
  ...
  queryLists: {
    ...
    tvShows: [
      ...
      { name: "Action & Adventure TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '10759', sort_by: 'popularity.desc', page }), param: "genre-10759" },
      { name: "Animation TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '16', sort_by: 'popularity.desc', page }), param: "genre-16" },
      { name: "Comedy TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '35', sort_by: 'popularity.desc', page }), param: "genre-35" },
      { name: "Crime TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '80', sort_by: 'popularity.desc', page }), param: "genre-80" },
      { name: "Documentary TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '99', sort_by: 'popularity.desc', page }), param: "genre-99" },
      { name: "Drama TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '18', sort_by: 'popularity.desc', page }), param: "genre-18" },
      { name: "Family TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '10751', sort_by: 'popularity.desc', page }), param: "genre-10751" },
      { name: "Kids TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '10762', sort_by: 'popularity.desc', page }), param: "genre-10762" },
      { name: "Mystery TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '9648', sort_by: 'popularity.desc', page }), param: "genre-9648" },
      { name: "Sci-Fi & Fantasy TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '10765', sort_by: 'popularity.desc', page }), param: "genre-10765" },
      { name: "War & Politics TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '10768', sort_by: 'popularity.desc', page }), param: "genre-10768" },
      { name: "Western TV", query: (page = 1) => tmdb.discover.tvShow({ with_genres: '37', sort_by: 'popularity.desc', page }), param: "genre-37" },
