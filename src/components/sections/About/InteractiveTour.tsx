...
const ProfilesSandbox = () => {
  ...
  const profiles = [
    { name: "Dad", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Felix&backgroundColor=b6e3f4" },
    { name: "Mom", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Aneka&backgroundColor=ffdfbf" },
    { name: "Kids", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jack&backgroundColor=d1d4f9" },
  ];
  return (
