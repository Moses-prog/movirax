  ...
  paragraphs: [
    {
      id: "welcome",
      content:
        "Welcome to MoviraX - a free and open-source movie streaming website. Please read this disclaimer carefully before using this website.",
    },
    {
      id: "purpose",
      content: "MoviraX is developed solely for",
    ...
    },
    {
      id: "content-source",
      content:
        "All content displayed on MoviraX (including but not limited to movies, images, posters, and related information) is sourced from",
      emphasis: "third-party providers through APIs or embedding.",
      continuation:
        "We do not host, store, or distribute any media files on our servers. The website merely aggregates content that is already available on the internet.",
    },
    {
      id: "responsibility",
      content:
        "By using MoviraX, you acknowledge that we bear no responsibility for user actions, content accuracy, or any direct or indirect damages arising from the use of this website. Users are solely responsible for their actions while using this service. We respect intellectual property rights and will respond to legitimate requests from copyright holders for content removal.",
    },
    {
      id: "usage",
      content:
        "This website should only be used for learning purposes. Any illegal activities, including but not limited to unauthorized downloading, redistribution of content, or commercial use, are strictly prohibited. By using MoviraX, you agree to these terms and acknowledge that",
