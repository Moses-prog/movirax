...
import { Button, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure, Select, SelectItem, Textarea, addToast, Input, Card, CardBody, CardHeader, User as HeroUser } from '@heroui/react';
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <Card className="mb-8 border-none bg-background/60 dark:bg-default-100/50 shadow-sm backdrop-blur-md">
        <CardBody className="p-6 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <HeroUser
            avatarProps={{ radius: "lg", size: "lg", src: user.avatar_url || `https://api.dicebear.com/9.x/notionists/svg?seed=${user.email}` }}
      ...
      <Card className="mt-8 border border-danger/20 bg-danger/5 shadow-sm backdrop-blur-md">
        <CardBody className="p-6">
